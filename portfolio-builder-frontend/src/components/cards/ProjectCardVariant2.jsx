    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end">
        <div className="w-full p-4 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
          <h3 className={`text-xl font-bold mb-1 text-white ${textSize}`}>
            {project.title}
          </h3>
          ...
          {project.github_link && (
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 backdrop-blur-sm text-white rounded hover:bg-white/30 transition-colors border border-white/30 text-sm"
            >
